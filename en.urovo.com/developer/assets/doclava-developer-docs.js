...
function getSection() {
  if (location.href.indexOf("../../../reference/index.html") != -1) {
    return "reference";
  } else if (location.href.indexOf("../../../guide/index.html") != -1) {
    return "guide";
  } else if (location.href.indexOf("../../../resources/index.html") != -1) {
    return "resources";
  }
  var basePath = getBaseUri(location.pathname);
  return basePath.substring(1,basePath.indexOf("../../../index.html",1));
}
...
function highlightNav(fullPageName) {
  var lastSlashPos = fullPageName.lastIndexOf("../../../index.html");
  var firstSlashPos;
  if (fullPageName.indexOf("../../../guide/index.html") != -1) {
      firstSlashPos = fullPageName.indexOf("../../../guide/index.html");
    } else if (fullPageName.indexOf("../../../sdk/index.html") != -1) {
      firstSlashPos = fullPageName.indexOf("../../../sdk/index.html");
    } else {
      firstSlashPos = fullPageName.indexOf("../../../resources/index.html");
    }
  ...
  if (link.length == 0) {
    ...
    if ((link.length == 0) && ((fullPageName.indexOf("../../../guide/index.html") != -1) || (fullPageName.indexOf("../../../resources/index.html") != -1))) {
      ...
      lastBackstep = pathPageName.lastIndexOf("../../../index.html");
      while (link.length == 0) {
        backstepDirectory = pathPageName.lastIndexOf("../../../index.html", lastBackstep);
        link = $("#devdoc-nav a[href$='"+ pathPageName.slice(0, backstepDirectory + 1)+"index.html']");
        lastBackstep = pathPageName.lastIndexOf("../../../index.html", lastBackstep - 1);
...
function resizeHeight() {
  ...
  if (href.indexOf("../../../reference/index.html") != -1) {
    var swapperHeight = windowHeight - 13;
    $("#swapper").css({height:swapperHeight + "px"});
  ...
  } else if (href.indexOf("../../../guide/index.html") != -1) {
    $("#devdoc-nav").css({height:sidenav.css("height")});
  } else if (href.indexOf("../../../resources/index.html") != -1) {
    $("#devdoc-nav").css({height:sidenav.css("height")});
  }
...
function getBaseUri(uri) {
  var intlUrl = (uri.substring(0,6) == "../../../intl/index.html");
  if (intlUrl) {
    base = uri.substring(uri.indexOf('intl/index.html')+5,uri.length);
    base = base.substring(base.indexOf('../../../index.html')+1, base.length);
...
$(window).unload(function(){
  ...
  if (path.indexOf("../../../reference/index.html") != -1) {
    writeCookie("lastpage", path, "reference", null);
  } else if (path.indexOf("../../../guide/index.html") != -1) {
    writeCookie("lastpage", path, "guide", null);
  } else if (path.indexOf("../../../resources/index.html") != -1) {
